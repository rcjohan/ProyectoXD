...
test('Cancelar Precertificacion Medico', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Usuario' }).fill('12382');
  await page.getByRole('textbox', { name: 'Usuario' }).press('Tab');
  await page.getByRole('textbox', { name: 'Contraseña' }).fill('12382');
  ...
  await page.getByRole('textbox', { name: 'Número precertificación' }).fill('5462406');
