...
// Playwright
test('Creacion Autorizacion servicio Ambulatorio Medico', async ({ page }) => {
...
await page.getByRole('textbox', { name: 'Código de procedimiento' }).fill('1086');
...
await expect(mensaje).toBeVisible({ timeout: 100000 });
